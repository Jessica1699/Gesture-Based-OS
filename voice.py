...
def respond(voice_data):
    ...
    # 8 Dynamic volume control and setting module
    if there_exists(["i want to set my volume","i want to change my volume","change the volume","set the volume","set my volume","change my volume"]):
        subprocess.call("python DynamicModule.py")
    ...
    if there_exists(["capture", "my screen", "screenshot"]):
        ...
        myScreenshot.save('C:/Users/James Braganza/Pictures/Screenshots/screen.png')
